...
resource "aws_lb_target_group" "filezip_tg" {
...
resource "aws_lb_target_group" "filezip_tg_1" {
...
resource "aws_lb_target_group" "filezip_tg_2" {
...
resource "aws_lb_listener" "nlb_listener" {
  ...
  default_action {
    type             = "forward"
    target_group_arn = aws_lb_target_group.filezip_tg.arn
  }
}
...
resource "aws_lb_listener" "nlb_listener_1" {
  ...
  default_action {
    type             = "forward"
    target_group_arn = aws_lb_target_group.filezip_tg_1.arn
  }
}
...
resource "aws_lb_listener" "nlb_listener_2" {
  ...
  default_action {
    type             = "forward"
    target_group_arn = aws_lb_target_group.filezip_tg_2.arn
  }
}
