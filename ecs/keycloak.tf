...
resource "aws_alb_listener" "https" {
  ...
  certificate_arn = "arn:aws:acm:us-east-1:110832778598:certificate/7f65ce88-ebac-4a05-89e7-6513c39c065d"
...
resource "aws_ecs_task_definition" "keycloak" {
  ...
  cpu                = 512
  memory             = 1024
  execution_role_arn = "arn:aws:iam::110832778598:role/LabRole"
